...
Thanks for helping keep Creator Studio and its users safe.

## Reporting a vulnerability

Please **do not** file a public GitHub issue for security problems.

- Preferred: [private vulnerability report](https://github.com/dirghaai/creator-studio/security/advisories/new) through GitHub's Security Advisories.
- Alternative: email `security@dirgha.ai` with the word `SECURITY` in the subject and `creator-studio` in the body.
